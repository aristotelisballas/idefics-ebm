...
food_groups_dict = {
    ...
    'Grains': ['rice', 'quinoa', 'oats', 'barley', 'wheat', 'bulgur', 'farro', 'couscous', 'millet', 'sorghum', 'buckwheat', 'amaranth', 'teff', 'spelt', 'rye', 'cornmeal', 'polenta', 'wild rice', 'fonio', 'triticale', 'einkorn', 'kamut', 'freekeh', 'sorghum', 'chickpea flour', 'semolina', 'chia seeds', 'quinoa flour', 'almond flour', 'coconut flour'],
